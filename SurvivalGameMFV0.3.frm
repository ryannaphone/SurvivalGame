...
Begin VB.Form MainForm 
   ...
   Begin VB.Frame CIFrame 
      ...
      Top             =   1440
      Width           =   3135
      Begin VB.CommandButton RawMeatConsume 
         Caption         =   "Raw Meat"
         BeginProperty Font 
            Name            =   "Rockwell"
            Size            =   12
   ...
   Begin VB.Frame HuntFrame 
      ...
      Top             =   1440
      Width           =   3135
      Begin VB.CommandButton SnipeHunt 
         Caption         =   "Snipe"
         BeginProperty Font 
            Name            =   "Rockwell"
            Size            =   12
   ...
   Begin VB.Frame CookFrame 
      ...
      Top             =   1440
      Width           =   3135
      Begin VB.CommandButton RawMeatCook 
         Caption         =   "Raw Meat"
         BeginProperty Font 
            Name            =   "Rockwell"
            Size            =   12
    ...
    Select Case KeyAscii
        ...
        Case 13
            If ConsoleOpen = True Then
                Select Case Console.Text
                    Case "StrawBerry"
                        Call UpdateBerry(999, False)
                    Case "Restart"
                        RestartGame
                    Case "JustForSean"
                        Bed = True
                        BedLabel.Caption = "Bed"
                        Cabin = True
                        CabinLabel.Caption = "Cabin"
                        StickShelt = True
                        SSLabel.Caption = "Stick Shelter"
                        Axe = True
                        AxeLabel.Caption = "Axe"
                        Knife = True
                        KnifeLabel.Caption = "Knife"
                        Spear = True
                        SpearLabel.Caption = "Spear"
                        Fire = True
                        FireLabel.Caption = "Fire"
                    Case "NoScope"
...
Private Sub RawMeatLabel_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    InfoLabel.Caption = "Info: Uncooked meat can be eaten for significantlyreduced stat increase and a chance to lose health."
End Sub
